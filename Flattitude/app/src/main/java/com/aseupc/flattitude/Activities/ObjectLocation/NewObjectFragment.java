 ...
 * {@link NewObjectFragment.OnNewFragmentInteractionListener} interface
...
public class NewObjectFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        addObject.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mListener.onAddObjectConfirmed(objectName, objectDescription);
            }
        });
    ...
    public void onAttach(Activity activity) {
        ...
        mListener = (OnNewFragmentInteractionListener) activity;
    }
